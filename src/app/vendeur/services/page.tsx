  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h1 className="text-xl font-bold capitalize">Vendeur / services</h1>
        <Link href="/dashboard"><Button variant="outline" size="sm" className="rounded-full">Voir dashboard complet</Button></Link>
      </div>
      <Card className="p-12 text-center">
        <div className="text-4xl mb-3">🚧</div>
        <h3 className="font-semibold">Module services</h3>
        <p className="text-sm text-[#6B7B6B] mt-1 max-w-[400px] mx-auto">Cette page /vendeur/services est prévue par l'architecture Vayeko. Elle sera connectée à Supabase avec RLS : un vendeur ne peut gérer que ses propres données. Validation, upload sécurisé, audit.</p>
