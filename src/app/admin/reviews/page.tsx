  ...
  return (
    <div className="min-h-screen bg-[#FFFEFB]">
      <div className="mx-auto max-w-[1100px] px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex items-center gap-3 mb-6"><ShieldCheck className="h-6 w-6 text-[#0E9F6E]" /><h1 className="text-2xl font-bold">Admin / reviews</h1><span className="text-xs bg-[#1A2E1A] text-white px-2.5 py-1 rounded-full">RLS Admin Only</span></div>
        <Card className="p-12 text-center">
          <div className="text-4xl mb-3">🛡️</div>
          <h3 className="font-semibold">Administration - reviews</h3>
